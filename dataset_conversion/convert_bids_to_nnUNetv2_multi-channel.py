"""
Convert BIDS-structured datasets (dcm-zurich-lesions, dcm-zurich-lesions-20231115) to the nnUNetv2 dataset MULTI-CHANNEL
format.
...
def get_parser():
    ...
    parser.add_argument('--dataset-name', '-dname', default='DCMlesionsMultiChannel', type=str,
                        help='Specify the task name.')
    parser.add_argument('--dataset-number', '-dnum', default=602, type=int,
